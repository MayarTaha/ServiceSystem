...
namespace ServiveceSystem.BusinessLayer
{
    public class QuotationHeaderService
    {
        ...
        public async Task<bool> AddQuotationHeader(QuotationHeader qout)
        {
            ...
            qout.CreatedLog = DateTime.Now.ToString();
            _context.QuotationHeaders.Add(qout);
            await _context.SaveChangesAsync();
            return true;
        }

        public async Task<bool> UpdateAsync(QuotationHeader qout)
        {
            var exists = await _context.QuotationHeaders
            ...
            qout.UpdatedLog = DateTime.Now.ToString();
