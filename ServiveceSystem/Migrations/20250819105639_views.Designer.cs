...
namespace ServiceSystem.Migrations
{
    ...
    [Migration("20250819105639_views")]
    partial class views
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceSystem.Models.View.InvoiceDetailView", b =>
                {
                    b.Property<decimal>("Discount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("ServiceSystem.Models.View.InvoiceHeaderView", b =>
                {
                    b.Property<int>("InvoiceHeaderId")
                        .HasColumnType("int");

                    b.Property<string>("ClinicContactName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("vw_InvoiceHeader", (string)null);
                });

            modelBuilder.Entity("ServiceSystem.Models.View.QuotationDetailView", b =>
                {
                    b.Property<decimal>("Discount")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToView("vw_QuotationDetail", (string)null);
                });

            modelBuilder.Entity("ServiceSystem.Models.View.QuotationHeaderView", b =>
                {
                    b.Property<int>("QuotationId")
                        .HasColumnType("int");
                    ...
                    b.ToView("vw_QuotationHeader", (string)null);
                });
